...
- A multi-part posting list should only be accessed via the main key. Accessing the posting list via one of the other keys was causing issues during rollup and adding spurious keys to the database. Now fixed. ([p4447][])
- Enterprise features
  - Backup types. Fixes [#4507][]. ([#4514][])

[p4447]: https://github.com/dgraph-io/dgraph/pull/4447
[p4672]: https://github.com/dgraph-io/dgraph/pull/4672
