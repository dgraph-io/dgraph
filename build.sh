...
echo "dgraph"
cd $dgraph_cmd/dgraph && go build -tags=embed .;
echo "dgraphassigner"
cd $dgraph_cmd/dgraphassigner && go build -tags=embed .;
echo "dgraphloader"
cd $dgraph_cmd/dgraphloader && go build -tags=embed .;
echo "dgraphlist"
cd $dgraph_cmd/dgraphlist && go build -tags=embed .;
echo "dgraphmerge"
cd $dgraph_cmd/dgraphmerge && go build -tags=embed .;
