...
func lexVariable(l *lex.Lexer) lex.StateFn {
	...
	// TODO(Aman): support limited characters in variable names.
	// For now, this is fine because variables names must be used once in query block
	// before they can be used here. We throw an error if number of used variables
	// are different than number of defined variables.
