...
sudo dgraph --port 80 --workerport 12345 --debugmode=true --nomutations=true --ui
~/go/src/github.com/dgraph-io/dgraph/dashboard/build --bindall=true --max_memory_mb=4096 2>&1 | tee -a dgraph.log
