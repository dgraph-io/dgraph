...
require (
	...
	github.com/dgraph-io/badger/v4 v4.0.1-0.20230228111748-e09e92b8a063
...
replace github.com/dgraph-io/badger/v4 => github.com/joshua-goldstein/badger/v4 v4.0.1
