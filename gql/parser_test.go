...
func TestParseSchemaInterospection(t *testing.T) {
	query := `
		schema (pred : name) {
			pred
			type
	...
	res, err := Parse(query)
	require.NoError(t, err)
	require.Equal(t, res.SchemaInterospection.Predicates[0], "name")
	require.Equal(t, len(res.SchemaInterospection.Attrs), 2)
	require.Equal(t, res.SchemaInterospection.Attrs[0], "pred")
	require.Equal(t, res.SchemaInterospection.Attrs[1], "type")
}

func TestParseSchemaInterospectionMulti(t *testing.T) {
	query := `
		schema (pred : name,hi) {
			pred
			type
	...
	res, err := Parse(query)
	require.NoError(t, err)
	require.Equal(t, len(res.SchemaInterospection.Predicates), 2)
	require.Equal(t, res.SchemaInterospection.Predicates[0], "name")
	require.Equal(t, res.SchemaInterospection.Predicates[1], "hi")
	require.Equal(t, len(res.SchemaInterospection.Attrs), 2)
	require.Equal(t, res.SchemaInterospection.Attrs[0], "pred")
	require.Equal(t, res.SchemaInterospection.Attrs[1], "type")
}

func TestParseSchemaInterospectionAll(t *testing.T) {
	query := `
		schema {
			pred
			type
	...
	res, err := Parse(query)
	require.NoError(t, err)
	require.Equal(t, len(res.SchemaInterospection.Predicates), 0)
	require.Equal(t, len(res.SchemaInterospection.Attrs), 2)
	require.Equal(t, res.SchemaInterospection.Attrs[0], "pred")
	require.Equal(t, res.SchemaInterospection.Attrs[1], "type")
}

func TestParseSchemaInterospectionWithComments(t *testing.T) {
	query := `
		schema (pred : name) {
			#hi
			pred #bye
...
func TestParseSchemaInterospectionAndQuery(t *testing.T) {
	query := `
		schema {
			pred
			type
...
func TestParseSchemaInterospectionError(t *testing.T) {
	query := `
		schema () {
			pred
			type
...
func TestParseSchemaInterospectionErrorMulti(t *testing.T) {
	query := `
		schema {
			pred
			type
