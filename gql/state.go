...
func lexTopLevel(l *lex.Lexer) lex.StateFn {
	// TODO(Aman): This won't work if more nested blocks other than the Upsert block
	// are added in the future. BlockDepth tells us nesting of blocks. Currently, only
