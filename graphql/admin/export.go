...
func (br *exportResolver) Rewrite(
...
func (br *exportResolver) FromMutationResult(
	mutation schema.Mutation,
...
func (br *exportResolver) Query(ctx context.Context, query *gql.GraphQuery) ([]byte, error) {
