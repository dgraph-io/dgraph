...
func (ulr *updateLambdaResolver) Resolve(ctx context.Context, m schema.Mutation) (*resolve.Resolved, bool) {
...
func (gsr *getLambdaResolver) Resolve(ctx context.Context, q schema.Query) *resolve.Resolved {
