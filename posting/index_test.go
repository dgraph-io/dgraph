...
func TestIndexingInt(t *testing.T) {
	schema.ParseBytes([]byte("age:int @index"))
...
func TestIndexingFloat(t *testing.T) {
	schema.ParseBytes([]byte("age:float @index"))
...
func TestIndexingDate(t *testing.T) {
	schema.ParseBytes([]byte("age:date @index"))
...
func TestIndexingTime(t *testing.T) {
	schema.ParseBytes([]byte("age:datetime @index"))
