...
// indexedPostingList stores the index of each posting in a posting list to avoid iterating over the list.
...
func (l *List) release() {
	...
	fromList(l.plist)
	for _, indexedPlist := range l.mutationMap {
		fromList(indexedPlist.plist)
	}
	l.plist = nil
	l.mutationMap = nil
}
