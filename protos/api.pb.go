...
func (m *Facet) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Val) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.Val)))
		i += copy(dAtA[i:], m.Val)
	}
	return i, nil
}
...
var fileDescriptorApi = []byte{
	...
	,
}
