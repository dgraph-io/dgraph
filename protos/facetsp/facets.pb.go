...
type KeyInfo struct {
	Fkey string `protobuf:"bytes,1,opt,name=fkey,proto3" json:"fkey,omitempty"`
	Fvar string `protobuf:"bytes,2,opt,name=fvar,proto3" json:"fvar,omitempty"`
}

func (m *KeyInfo) Reset()                    { *m = KeyInfo{} }
func (m *KeyInfo) String() string            { return proto.CompactTextString(m) }
func (*KeyInfo) ProtoMessage()               {}
func (*KeyInfo) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{1} }

func (m *KeyInfo) GetFkey() string {
	if m != nil {
		return m.Fkey
	}
	return ""
...
type Param struct {
	...
	Keys    []*KeyInfo `protobuf:"bytes,2,rep,name=keys" json:"keys,omitempty"`
}

func (m *Param) Reset()                    { *m = Param{} }
func (m *Param) String() string            { return proto.CompactTextString(m) }
func (*Param) ProtoMessage()               {}
func (*Param) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{2} }
...
func (*Facets) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{3} }
...
func (*List) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{4} }
...
func (*Function) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{5} }
...
func (*FilterTree) Descriptor() ([]byte, []int) { return fileDescriptorFacets, []int{6} }
...
func init() {
	...
	proto.RegisterType((*KeyInfo)(nil), "facetsp.keyInfo")
...
func (m *KeyInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Fkey) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintFacets(dAtA, i, uint64(len(m.Fkey)))
		i += copy(dAtA[i:], m.Fkey)
	}
	if len(m.Fvar) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintFacets(dAtA, i, uint64(len(m.Fvar)))
		i += copy(dAtA[i:], m.Fvar)
	}
	return i, nil
}
...
func (m *KeyInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Fkey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Fvar", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Fvar = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipFacets(dAtA[iNdEx:])
...
var fileDescriptorFacets = []byte{
	...
	,
}
