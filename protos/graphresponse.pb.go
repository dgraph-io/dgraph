...
type Request struct {
	...
	MutationSet []byte            `protobuf:"bytes,5,opt,name=mutation_set,json=mutationSet,proto3" json:"mutation_set,omitempty"`
	MutationDel []byte            `protobuf:"bytes,6,opt,name=mutation_del,json=mutationDel,proto3" json:"mutation_del,omitempty"`
}
...
func (m *Request) GetMutationSet() []byte {
	if m != nil {
		return m.MutationSet
	}
	return nil
}

func (m *Request) GetMutationDel() []byte {
	if m != nil {
		return m.MutationDel
	}
	return nil
}
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MutationSet) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(len(m.MutationSet)))
		i += copy(dAtA[i:], m.MutationSet)
	}
	if len(m.MutationDel) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(len(m.MutationDel)))
		i += copy(dAtA[i:], m.MutationDel)
	}
	return i, nil
}
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MutationSet", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MutationSet = append(m.MutationSet[:0], dAtA[iNdEx:postIndex]...)
			if m.MutationSet == nil {
				m.MutationSet = []byte{}
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MutationDel", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MutationDel = append(m.MutationDel[:0], dAtA[iNdEx:postIndex]...)
			if m.MutationDel == nil {
				m.MutationDel = []byte{}
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
