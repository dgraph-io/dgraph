...
type NQuad struct {
	...
	ObjectVal   string   `protobuf:"bytes,10,opt,name=object_val,json=objectVal,proto3" json:"object_val,omitempty"`
}
...
func (m *NQuad) GetObjectVal() string {
	if m != nil {
		return m.ObjectVal
	}
	return ""
...
func (m *NQuad) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ObjectVal) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(len(m.ObjectVal)))
		i += copy(dAtA[i:], m.ObjectVal)
	}
	return i, nil
}
...
func (m *NQuad) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ObjectVal", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ObjectVal = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGraphresponse(dAtA[iNdEx:])
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
