...
type ZeroProposal struct {
	DeprecatedId uint32          `protobuf:"varint,1,opt,name=deprecated_id,json=deprecatedId,proto3" json:"deprecated_id,omitempty"`
...
func (m *ZeroProposal) GetDeprecatedId() uint32 {
	if m != nil {
		return m.DeprecatedId
	}
	return 0
}
...
type Snapshot struct {
	...
	MinPendingStartTs uint64       `protobuf:"varint,3,opt,name=min_pending_start_ts,json=minPendingStartTs,proto3" json:"min_pending_start_ts,omitempty"`
}

func (m *Snapshot) Reset()                    { *m = Snapshot{} }
func (m *Snapshot) String() string            { return proto.CompactTextString(m) }
func (*Snapshot) ProtoMessage()               {}
func (*Snapshot) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{20} }
...
func (m *Snapshot) GetMinPendingStartTs() uint64 {
	if m != nil {
		return m.MinPendingStartTs
	}
	return 0
}
...
type Proposal struct {
	DeprecatedId         uint32           `protobuf:"varint,1,opt,name=deprecated_id,json=deprecatedId,proto3" json:"deprecated_id,omitempty"`
	DeprecatedTxnContext *api.TxnContext  `protobuf:"bytes,3,opt,name=deprecated_txn_context,json=deprecatedTxnContext" json:"deprecated_txn_context,omitempty"`
...
func (*Proposal) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{21} }

func (m *Proposal) GetDeprecatedId() uint32 {
	if m != nil {
		return m.DeprecatedId
	}
	return 0
...
func (m *Proposal) GetDeprecatedTxnContext() *api.TxnContext {
	if m != nil {
		return m.DeprecatedTxnContext
	}
	return nil
}
...
func (*KVS) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{22} }
...
func (*KV) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{23} }
...
type OracleDelta struct {
	...
	MaxAssigned uint64            `protobuf:"varint,3,opt,name=max_assigned,json=maxAssigned,proto3" json:"max_assigned,omitempty"`
}
...
func (*PeerResponse) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{40} }
...
func (*RaftBatch) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{41} }
...
func (*Num) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{42} }
...
func (*SnapshotMeta) Descriptor() ([]byte, []int) { return fileDescriptorInternal, []int{43} }
...
func (c *raftClient) IsPeer(ctx context.Context, in *RaftContext, opts ...grpc.CallOption) (*PeerResponse, error) {
	...
	err := grpc.Invoke(ctx, "/intern.Raft/IsPeer", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (x *workerPredicateAndSchemaDataClient) Recv() (*KVS, error) {
	m := new(KVS)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *workerPredicateAndSchemaDataServer) Send(m *KVS) error {
	return x.ServerStream.SendMsg(m)
}
...
func (m *ZeroProposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeprecatedId != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintInternal(dAtA, i, uint64(m.DeprecatedId))
	}
	if m.Member != nil {
		dAtA[i] = 0x12
		i++
...
func (m *Snapshot) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MinPendingStartTs != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintInternal(dAtA, i, uint64(m.MinPendingStartTs))
	}
	return i, nil
}
...
func (m *Proposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mutations != nil {
		...
		n21, err := m.Mutations.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	}
	if m.DeprecatedTxnContext != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintInternal(dAtA, i, uint64(m.DeprecatedTxnContext.Size()))
		n22, err := m.DeprecatedTxnContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.Delta != nil {
		...
		n24, err := m.Delta.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.Snapshot != nil {
		...
		n25, err := m.Snapshot.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *FilterTree) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Func != nil {
		...
		n26, err := m.Func.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *MapEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Posting != nil {
		...
		n27, err := m.Posting.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *OracleDelta) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Aborts) > 0 {
		dAtA30 := make([]byte, len(m.Aborts)*10)
		var j29 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintInternal(dAtA, i, uint64(j29))
...
func (m *TxnTimestamps) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Ts) > 0 {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintInternal(dAtA, i, uint64(j31))
...
func (m *ZeroProposal) Size() (n int) {
	...
	_ = l
	if m.DeprecatedId != 0 {
		n += 1 + sovInternal(uint64(m.DeprecatedId))
	}
	if m.Member != nil {
		l = m.Member.Size()
		n += 1 + l + sovInternal(uint64(l))
...
func (m *Snapshot) Size() (n int) {
	...
	if m.MinPendingStartTs != 0 {
		n += 1 + sovInternal(uint64(m.MinPendingStartTs))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DeprecatedId |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Snapshot) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinPendingStartTs", wireType)
			}
			m.MinPendingStartTs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowInternal
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinPendingStartTs |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Proposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeprecatedTxnContext", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DeprecatedTxnContext == nil {
				m.DeprecatedTxnContext = &api.TxnContext{}
			}
			if err := m.DeprecatedTxnContext.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
var fileDescriptorInternal = []byte{
	...
	,
	...
	,
}
