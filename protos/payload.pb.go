...
type ZeroClient interface {
	...
	Update(ctx context.Context, in *Member, opts ...grpc.CallOption) (*MembershipState, error)
...
func (c *zeroClient) Update(ctx context.Context, in *Member, opts ...grpc.CallOption) (*MembershipState, error) {
	out := new(MembershipState)
...
type ZeroServer interface {
	...
	Update(context.Context, *Member) (*MembershipState, error)
...
func _Zero_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZeroServer).Update(ctx, req.(*Member))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorPayload = []byte{
	...
	,
}
