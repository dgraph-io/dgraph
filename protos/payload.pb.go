...
func (*TxnContext) Descriptor() ([]byte, []int) { return fileDescriptorPayload, []int{3} }
...
func (m *TxnContext) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartTs != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintPayload(dAtA, i, uint64(m.StartTs))
	}
	if m.CommitTs != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintPayload(dAtA, i, uint64(m.CommitTs))
	}
	return i, nil
}
...
func (m *TxnContext) Size() (n int) {
	...
	if m.StartTs != 0 {
		n += 1 + sovPayload(uint64(m.StartTs))
	}
	if m.CommitTs != 0 {
		n += 1 + sovPayload(uint64(m.CommitTs))
	}
	return n
}
...
var fileDescriptorPayload = []byte{
	...
	,
}
