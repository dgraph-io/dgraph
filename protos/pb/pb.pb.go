...
var file_pb_proto_rawDesc = []byte{
	...
	0x87, 0x08, 0x0a, 0x06, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x06, 0x4d, 0x75,
	...
	,
...
var file_pb_proto_depIdxs = []int32{
	...
	95,  // 122: pb.Worker.ProposeSnapshotAndWait:input_type -> api.v2.UpdateExtSnapshotStreamingStateRequest
	99,  // 123: pb.Worker.StreamExtSnapshot:input_type -> api.v2.StreamExtSnapshotRequest
	25,  // 124: pb.Raft.Heartbeat:output_type -> pb.HealthInfo
	96,  // 125: pb.Raft.RaftMessage:output_type -> api.Payload
	96,  // 126: pb.Raft.JoinCluster:output_type -> api.Payload
	58,  // 127: pb.Raft.IsPeer:output_type -> pb.PeerResponse
	24,  // 128: pb.Zero.Connect:output_type -> pb.ConnectionState
	96,  // 129: pb.Zero.UpdateMembership:output_type -> api.Payload
	...
	60,  // 133: pb.Zero.Inform:output_type -> pb.TabletResponse
	65,  // 134: pb.Zero.AssignIds:output_type -> pb.AssignedIds
	65,  // 135: pb.Zero.Timestamps:output_type -> pb.AssignedIds
	92,  // 136: pb.Zero.CommitOrAbort:output_type -> api.TxnContext
	56,  // 137: pb.Zero.TryAbort:output_type -> pb.OracleDelta
	69,  // 138: pb.Zero.DeleteNamespace:output_type -> pb.Status
	69,  // 139: pb.Zero.RemoveNode:output_type -> pb.Status
	69,  // 140: pb.Zero.MoveTablet:output_type -> pb.Status
	92,  // 141: pb.Worker.Mutate:output_type -> api.TxnContext
	...
	71,  // 146: pb.Worker.Backup:output_type -> pb.BackupResponse
	69,  // 147: pb.Worker.Restore:output_type -> pb.Status
	74,  // 148: pb.Worker.Export:output_type -> pb.ExportResponse
	96,  // 149: pb.Worker.ReceivePredicate:output_type -> api.Payload
	96,  // 150: pb.Worker.MovePredicate:output_type -> api.Payload
	98,  // 151: pb.Worker.Subscribe:output_type -> badgerpb4.KVList
	78,  // 152: pb.Worker.UpdateGraphQLSchema:output_type -> pb.UpdateGraphQLSchemaResponse
	69,  // 153: pb.Worker.DeleteNamespace:output_type -> pb.Status
	82,  // 154: pb.Worker.TaskStatus:output_type -> pb.TaskStatusResponse
	69,  // 155: pb.Worker.UpdateExtSnapshotStreamingState:output_type -> pb.Status
	69,  // 156: pb.Worker.ProposeSnapshotAndWait:output_type -> pb.Status
	100, // 157: pb.Worker.StreamExtSnapshot:output_type -> api.v2.StreamExtSnapshotResponse
