...
const (
	...
	// that uses this).
	Posting_VFLOAT Posting_ValType = 12
)
...
func (BackupKey_KeyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{68, 0}
}
...
type Result struct {
	...
	ExtraMetrics  map[string]uint64 `protobuf:"bytes,8,rep,name=extra_metrics,json=extraMetrics,proto3" json:"extra_metrics,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *Result) GetExtraMetrics() map[string]uint64 {
	if m != nil {
...
type RestoreRequest struct {
	...
	SecretKey    Sensitive `protobuf:"bytes,6,opt,name=secret_key,json=secretKey,proto3,customtype=Sensitive" json:"secret_key"`
	SessionToken Sensitive `protobuf:"bytes,7,opt,name=session_token,json=sessionToken,proto3,customtype=Sensitive" json:"session_token"`
...
func (m *RestoreRequest) GetFromNamespace() uint64 {
	if m != nil {
		return m.FromNamespace
	}
	return 0
}

func (m *RestoreRequest) GetIsNamespaceAwareRestore() bool {
	if m != nil {
		return m.IsNamespaceAwareRestore
	}
	return false
}
...
func (m *SchemaNode) GetUnique() bool {
	if m != nil {
		return m.Unique
	}
	return false
...
type SchemaUpdate struct {
	...
	VectorSpecs    []*VectorSpec `protobuf:"bytes,15,rep,name=vector_specs,json=vectorSpecs,proto3" json:"vector_specs,omitempty"`
}
...
func (m *SchemaUpdate) GetUnique() bool {
	if m != nil {
		return m.Unique
	}
	return false
...
func (m *SchemaUpdate) GetVectorSpecs() []*VectorSpec {
	if m != nil {
		return m.VectorSpecs
	}
	return nil
}
...
func (m *VectorSpec) Reset()         { *m = VectorSpec{} }
func (m *VectorSpec) String() string { return proto.CompactTextString(m) }
func (*VectorSpec) ProtoMessage()    {}
func (*VectorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{42}
}
func (m *VectorSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VectorSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VectorSpec.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VectorSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VectorSpec.Merge(m, src)
}
func (m *VectorSpec) XXX_Size() int {
	return m.Size()
}
func (m *VectorSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_VectorSpec.DiscardUnknown(m)
}

var xxx_messageInfo_VectorSpec proto.InternalMessageInfo

func (m *VectorSpec) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *OptionPair) Reset()         { *m = OptionPair{} }
func (m *OptionPair) String() string { return proto.CompactTextString(m) }
func (*OptionPair) ProtoMessage()    {}
func (*OptionPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{43}
}
func (m *OptionPair) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OptionPair) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OptionPair.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OptionPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OptionPair.Merge(m, src)
}
func (m *OptionPair) XXX_Size() int {
	return m.Size()
}
func (m *OptionPair) XXX_DiscardUnknown() {
	xxx_messageInfo_OptionPair.DiscardUnknown(m)
}

var xxx_messageInfo_OptionPair proto.InternalMessageInfo

func (m *OptionPair) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *OptionPair) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
type BackupRequest struct {
	...
	SecretKey    Sensitive `protobuf:"bytes,7,opt,name=secret_key,json=secretKey,proto3,customtype=Sensitive" json:"secret_key"`
	SessionToken Sensitive `protobuf:"bytes,8,opt,name=session_token,json=sessionToken,proto3,customtype=Sensitive" json:"session_token"`
...
func (*TaskStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{74}
}
...
func (*TaskStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{75}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]uint64)(nil), "pb.Result.ExtraMetricsEntry")
	...
	proto.RegisterType((*VectorSpec)(nil), "pb.VectorSpec")
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *SchemaUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.VectorSpecs) > 0 {
		for iNdEx := len(m.VectorSpecs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.VectorSpecs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *VectorSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VectorSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VectorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RestoreRequest) Size() (n int) {
	...
	if m.FromNamespace != 0 {
		n += 2 + sovPb(uint64(m.FromNamespace))
	}
	if m.IsNamespaceAwareRestore {
		n += 3
	}
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.ExtraMetrics == nil {
				m.ExtraMetrics = make(map[string]uint64)
			}
			var mapkey string
			var mapvalue uint64
			for iNdEx < postIndex {
...
func (m *SchemaUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VectorSpecs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VectorSpecs = append(m.VectorSpecs, &VectorSpec{})
			if err := m.VectorSpecs[len(m.VectorSpecs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VectorSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VectorSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VectorSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OptionPair) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
