...
type ParseMetadata struct {
	...
	ForcedSinglePreds []string `protobuf:"bytes,1,rep,name=forced_single_preds,json=forcedSinglePreds,proto3" json:"forced_single_preds,omitempty"`
	// The name of the predicates that should be created as list predicates
	// if they don't exist in the schema.
	ForcedListPreds      []string `protobuf:"bytes,2,rep,name=forced_list_preds,json=forcedListPreds,proto3" json:"forced_list_preds,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ParseMetadata) GetForcedSinglePreds() []string {
	if m != nil {
...
func (m *ParseMetadata) GetForcedListPreds() []string {
	if m != nil {
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *ParseMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForcedListPreds) > 0 {
		for iNdEx := len(m.ForcedListPreds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPb(dAtA, i, uint64(len(m.ForcedListPreds[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.ForcedSinglePreds) > 0 {
		for iNdEx := len(m.ForcedSinglePreds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPb(dAtA, i, uint64(len(m.ForcedSinglePreds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
