...
type ParseMetadata_HintType int32

const (
	// DEFAULT means no hint is provided and Dgraph will follow the default behavior.
	ParseMetadata_DEFAULT ParseMetadata_HintType = 0
	// SINGLE signals that the predicate should be created as a single type (e.g string, uid).
	ParseMetadata_SINGLE ParseMetadata_HintType = 1
	// LIST signals that the predicate should be created as a list (e.g [string], [uid]).
	ParseMetadata_LIST ParseMetadata_HintType = 2
)

var ParseMetadata_HintType_name = map[int32]string{
	0: "DEFAULT",
	1: "SINGLE",
	2: "LIST",
}

var ParseMetadata_HintType_value = map[string]int32{
	"DEFAULT": 0,
	"SINGLE":  1,
	"LIST":    2,
}

func (x ParseMetadata_HintType) String() string {
	return proto.EnumName(ParseMetadata_HintType_name, int32(x))
}

func (ParseMetadata_HintType) EnumDescriptor() ([]byte, []int) {
...
type Mutations struct {
	...
	ParseMetadata        *ParseMetadata   `protobuf:"bytes,9,opt,name=parse_metadata,json=parseMetadata,proto3" json:"parse_metadata,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Mutations) GetParseMetadata() *ParseMetadata {
	if m != nil {
...
type ParseMetadata struct {
	...
	PredHints            map[string]ParseMetadata_HintType `protobuf:"bytes,1,rep,name=pred_hints,json=predHints,proto3" json:"pred_hints,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=pb.ParseMetadata_HintType"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}

func (m *ParseMetadata) Reset()         { *m = ParseMetadata{} }
func (m *ParseMetadata) String() string { return proto.CompactTextString(m) }
func (*ParseMetadata) ProtoMessage()    {}
func (*ParseMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{20}
}
func (m *ParseMetadata) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ParseMetadata) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ParseMetadata.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ParseMetadata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseMetadata.Merge(m, src)
}
func (m *ParseMetadata) XXX_Size() int {
	return m.Size()
}
func (m *ParseMetadata) XXX_DiscardUnknown() {
	xxx_messageInfo_ParseMetadata.DiscardUnknown(m)
}

var xxx_messageInfo_ParseMetadata proto.InternalMessageInfo

func (m *ParseMetadata) GetPredHints() map[string]ParseMetadata_HintType {
	if m != nil {
		return m.PredHints
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("pb.ParseMetadata_HintType", ParseMetadata_HintType_name, ParseMetadata_HintType_value)
	...
	proto.RegisterType((*ParseMetadata)(nil), "pb.ParseMetadata")
	proto.RegisterMapType((map[string]ParseMetadata_HintType)(nil), "pb.ParseMetadata.PredHintsEntry")
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *Mutations) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ParseMetadata != nil {
		{
			size, err := m.ParseMetadata.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ParseMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ParseMetadata) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ParseMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ParseMetadata) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Mutations) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParseMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ParseMetadata == nil {
				m.ParseMetadata = &ParseMetadata{}
			}
			if err := m.ParseMetadata.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ParseMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ParseMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ParseMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.PredHints == nil {
				m.PredHints = make(map[string]ParseMetadata_HintType)
			}
			var mapkey string
			var mapvalue ParseMetadata_HintType
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					for shift := uint(0); ; shift += 7 {
						...
						b := dAtA[iNdEx]
						iNdEx++
						mapvalue |= ParseMetadata_HintType(b&0x7F) << shift
						if b < 0x80 {
							break
						}
					}
