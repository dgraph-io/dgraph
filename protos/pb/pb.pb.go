...
func (x *PDirReadyStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PDirReadyStatus) ProtoMessage() {}

func (x *PDirReadyStatus) ProtoReflect() protoreflect.Message {
	mi := &file_pb_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PDirReadyStatus.ProtoReflect.Descriptor instead.
func (*PDirReadyStatus) Descriptor() ([]byte, []int) {
	return file_pb_proto_rawDescGZIP(), []int{52}
}

func (x *PDirReadyStatus) GetIsReady() bool {
	if x != nil {
		return x.IsReady
	}
	return false
...
func (x *PDirReadyStatus) GetAck() bool {
	if x != nil {
		return x.Ack
	}
	return false
...
var file_pb_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x61, 0x64, 0x22, 0x3d, 0x0a, 0x0f, 0x50, 0x44, 0x69, 0x72, 0x52, 0x65, 0x61, 0x64,
	0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x69, 0x73, 0x52, 0x65, 0x61,
	0x64, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x52, 0x65, 0x61, 0x64,
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03,
	0x61, 0x63, 0x6b, 0x22, 0x36, 0x0a, 0x0e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x74, 0x52, 0x65, 0x73,
	...
	0x22, 0x00, 0x32, 0xa6, 0x06, 0x0a, 0x06, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12, 0x2a, 0x0a,
	...
	0x65, 0x22, 0x00, 0x12, 0x36, 0x0a, 0x08, 0x50, 0x44, 0x69, 0x72, 0x53, 0x74, 0x61, 0x74, 0x12,
	0x13, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x44, 0x69, 0x72, 0x52, 0x65, 0x61, 0x64, 0x79, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x1a, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x44, 0x69, 0x72, 0x52, 0x65,
	0x61, 0x64, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x00, 0x32, 0x38, 0x0a, 0x07, 0x49,
	0x6d, 0x70, 0x6f, 0x72, 0x74, 0x50, 0x12, 0x2d, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
...
var file_pb_proto_goTypes = []interface{}{
	...
	(*PDirReadyStatus)(nil),             // 61: pb.PDirReadyStatus
...
var file_pb_proto_depIdxs = []int32{
	...
	96,  // 51: pb.Posting.facets:type_name -> api.Facet
	...
	96,  // 56: pb.Facets.facets:type_name -> api.Facet
	...
	93,  // 68: pb.OracleDelta.group_checksums:type_name -> pb.OracleDelta.GroupChecksumsEntry
	19,  // 69: pb.RaftBatch.context:type_name -> pb.RaftContext
	98,  // 70: pb.RaftBatch.payload:type_name -> api.Payload
	27,  // 71: pb.TabletResponse.tablets:type_name -> pb.Tablet
	27,  // 72: pb.TabletRequest.tablets:type_name -> pb.Tablet
	99,  // 73: pb.SubscriptionRequest.matches:type_name -> badgerpb4.Match
	100, // 74: pb.SubscriptionResponse.kvs:type_name -> badgerpb4.KVList
	6,   // 75: pb.Num.type:type_name -> pb.Num.leaseType
	75,  // 76: pb.BackupResponse.drop_operations:type_name -> pb.DropOperation
	...
	94,  // 82: pb.BulkMeta.schema_map:type_name -> pb.BulkMeta.SchemaMapEntry
	...
	98,  // 90: pb.Raft.Heartbeat:input_type -> api.Payload
	...
	98,  // 96: pb.Zero.StreamMembership:input_type -> api.Payload
	98,  // 97: pb.Zero.Oracle:input_type -> api.Payload
	27,  // 98: pb.Zero.ShouldServe:input_type -> pb.Tablet
	63,  // 99: pb.Zero.Inform:input_type -> pb.TabletRequest
	66,  // 100: pb.Zero.AssignIds:input_type -> pb.Num
	66,  // 101: pb.Zero.Timestamps:input_type -> pb.Num
	95,  // 102: pb.Zero.CommitOrAbort:input_type -> api.TxnContext
	58,  // 103: pb.Zero.TryAbort:input_type -> pb.TxnTimestamps
	83,  // 104: pb.Zero.DeleteNamespace:input_type -> pb.DeleteNsRequest
	68,  // 105: pb.Zero.RemoveNode:input_type -> pb.RemoveNodeRequest
	69,  // 106: pb.Zero.MoveTablet:input_type -> pb.MoveTabletRequest
	70,  // 107: pb.Zero.ApplyLicense:input_type -> pb.ApplyLicenseRequest
	...
	73,  // 113: pb.Worker.Backup:input_type -> pb.BackupRequest
	33,  // 114: pb.Worker.Restore:input_type -> pb.RestoreRequest
	76,  // 115: pb.Worker.Export:input_type -> pb.ExportRequest
	36,  // 116: pb.Worker.ReceivePredicate:input_type -> pb.KVS
	55,  // 117: pb.Worker.MovePredicate:input_type -> pb.MovePredicatePayload
	64,  // 118: pb.Worker.Subscribe:input_type -> pb.SubscriptionRequest
	80,  // 119: pb.Worker.UpdateGraphQLSchema:input_type -> pb.UpdateGraphQLSchemaRequest
	83,  // 120: pb.Worker.DeleteNamespace:input_type -> pb.DeleteNsRequest
	84,  // 121: pb.Worker.TaskStatus:input_type -> pb.TaskStatusRequest
	61,  // 122: pb.Worker.PDirStat:input_type -> pb.PDirReadyStatus
	31,  // 123: pb.ImportP.StreamSnapshot:input_type -> pb.Snapshot
	26,  // 124: pb.Raft.Heartbeat:output_type -> pb.HealthInfo
	98,  // 125: pb.Raft.RaftMessage:output_type -> api.Payload
	98,  // 126: pb.Raft.JoinCluster:output_type -> api.Payload
	59,  // 127: pb.Raft.IsPeer:output_type -> pb.PeerResponse
	25,  // 128: pb.Zero.Connect:output_type -> pb.ConnectionState
	98,  // 129: pb.Zero.UpdateMembership:output_type -> api.Payload
	24,  // 130: pb.Zero.StreamMembership:output_type -> pb.MembershipState
	57,  // 131: pb.Zero.Oracle:output_type -> pb.OracleDelta
	27,  // 132: pb.Zero.ShouldServe:output_type -> pb.Tablet
	62,  // 133: pb.Zero.Inform:output_type -> pb.TabletResponse
	67,  // 134: pb.Zero.AssignIds:output_type -> pb.AssignedIds
	67,  // 135: pb.Zero.Timestamps:output_type -> pb.AssignedIds
	95,  // 136: pb.Zero.CommitOrAbort:output_type -> api.TxnContext
	57,  // 137: pb.Zero.TryAbort:output_type -> pb.OracleDelta
	72,  // 138: pb.Zero.DeleteNamespace:output_type -> pb.Status
	72,  // 139: pb.Zero.RemoveNode:output_type -> pb.Status
	72,  // 140: pb.Zero.MoveTablet:output_type -> pb.Status
	72,  // 141: pb.Zero.ApplyLicense:output_type -> pb.Status
	95,  // 142: pb.Worker.Mutate:output_type -> api.TxnContext
	15,  // 143: pb.Worker.ServeTask:output_type -> pb.Result
	36,  // 144: pb.Worker.StreamSnapshot:output_type -> pb.KVS
	18,  // 145: pb.Worker.Sort:output_type -> pb.SortResult
	49,  // 146: pb.Worker.Schema:output_type -> pb.SchemaResult
	74,  // 147: pb.Worker.Backup:output_type -> pb.BackupResponse
	72,  // 148: pb.Worker.Restore:output_type -> pb.Status
	77,  // 149: pb.Worker.Export:output_type -> pb.ExportResponse
	98,  // 150: pb.Worker.ReceivePredicate:output_type -> api.Payload
	98,  // 151: pb.Worker.MovePredicate:output_type -> api.Payload
	100, // 152: pb.Worker.Subscribe:output_type -> badgerpb4.KVList
	81,  // 153: pb.Worker.UpdateGraphQLSchema:output_type -> pb.UpdateGraphQLSchemaResponse
	72,  // 154: pb.Worker.DeleteNamespace:output_type -> pb.Status
	85,  // 155: pb.Worker.TaskStatus:output_type -> pb.TaskStatusResponse
	61,  // 156: pb.Worker.PDirStat:output_type -> pb.PDirReadyStatus
	36,  // 157: pb.ImportP.StreamSnapshot:output_type -> pb.KVS
