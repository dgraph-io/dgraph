...
type MembershipState struct {
	...
	Zeros        map[uint64]*Member `protobuf:"bytes,2,rep,name=zeros" json:"zeros,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	MaxLeaseId   uint64             `protobuf:"varint,3,opt,name=maxLeaseId,proto3" json:"maxLeaseId,omitempty"`
...
type Proposal struct {
	...
	KeyValues  *KeyValues `protobuf:"bytes,4,opt,name=keyValues" json:"keyValues,omitempty"`
}
...
func (m *Proposal) GetKeyValues() *KeyValues {
	if m != nil {
		return m.KeyValues
	}
	return nil
...
func (m *Proposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.KeyValues != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.KeyValues.Size()))
		n16, err := m.KeyValues.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *KV) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Meta) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTask(dAtA, i, uint64(len(m.Meta)))
...
func (m *Proposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if err := m.KeyValues.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTask = []byte{
	...
	,
}
