...
type Tablet struct {
	...
	PrevGroup uint32 `protobuf:"varint,3,opt,name=prev_group,json=prevGroup,proto3" json:"prev_group,omitempty"`
...
func (m *Tablet) GetPrevGroup() uint32 {
	if m != nil {
		return m.PrevGroup
	}
	return 0
...
func (m *Tablet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrevGroup != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.PrevGroup))
	}
	if m.ReadOnly {
		dAtA[i] = 0x20
		i++
...
func (m *Tablet) Size() (n int) {
	...
	if m.PrevGroup != 0 {
		n += 1 + sovTask(uint64(m.PrevGroup))
	}
	if m.ReadOnly {
		n += 2
	}
...
func (m *Tablet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevGroup", wireType)
			}
			m.PrevGroup = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrevGroup |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTask = []byte{
	...
	,
}
