...
func (*Upsert) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{11} }

func (m *Upsert) GetAttr() string {
	if m != nil {
		return m.Attr
	}
	return ""
...
type Mutations struct {
	...
	Upsert  *Upsert         `protobuf:"bytes,4,opt,name=upsert" json:"upsert,omitempty"`
}
...
func (m *Mutations) GetUpsert() *Upsert {
	if m != nil {
		return m.Upsert
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Upsert)(nil), "protos.Upsert")
...
func (m *Upsert) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Arg) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTask(dAtA, i, uint64(len(m.Arg)))
		i += copy(dAtA[i:], m.Arg)
	}
	return i, nil
}
...
func (m *Mutations) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Upsert != nil {
		...
		n6, err := m.Upsert.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
var fileDescriptorTask = []byte{
	...
	,
}
