...
func (*ZeroProposal) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{10} }
...
func (m *Proposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mutations != nil {
		...
		n12, err := m.Mutations.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.Membership != nil {
		...
		n13, err := m.Membership.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
var fileDescriptorTask = []byte{
	...
	,
}
