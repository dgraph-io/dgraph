...
type SortMessage struct {
	Attr      []string `protobuf:"bytes,1,rep,name=attr" json:"attr,omitempty"`
	Langs     []string `protobuf:"bytes,2,rep,name=langs" json:"langs,omitempty"`
	...
	Desc      []bool   `protobuf:"varint,6,rep,packed,name=desc" json:"desc,omitempty"`
}
...
func (m *SortMessage) Size() (n int) {
	...
	if len(m.Desc) > 0 {
		n += 1 + sovTask(uint64(len(m.Desc))) + len(m.Desc)*1
	}
	return n
}
...
var fileDescriptorTask = []byte{
	...
	,
}
