...
type Query struct {
	...
	Linearized   bool        `protobuf:"varint,10,opt,name=linearized,proto3" json:"linearized,omitempty"`
}
...
func (m *Query) GetLinearized() bool {
	if m != nil {
		return m.Linearized
	}
	return false
...
type SortMessage struct {
	...
	Linearized bool     `protobuf:"varint,7,opt,name=linearized,proto3" json:"linearized,omitempty"`
}
...
func (m *SortMessage) GetLinearized() bool {
	if m != nil {
		return m.Linearized
	}
	return false
...
func (m *Query) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Linearized", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorTask = []byte{
	...
	,
}
