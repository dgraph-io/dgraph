...
type Sort struct {
	...
	VarValMap map[uint64]*Value `protobuf:"bytes,7,rep,name=varValMap" json:"varValMap,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *Sort) GetVarValMap() map[uint64]*Value {
	if m != nil {
		return m.VarValMap
	}
	return nil
...
func (m *Sort) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.VarValMap) > 0 {
		for k, _ := range m.VarValMap {
			dAtA[i] = 0x3a
			i++
			v := m.VarValMap[k]
			msgSize := 0
...
func (m *Num) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Uids) > 0 {
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTask(dAtA, i, uint64(j7))
...
func (m *Proposal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mutations != nil {
		...
		n9, err := m.Mutations.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	if m.RebuildIndex != nil {
		...
		n11, err := m.RebuildIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *Sort) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VarValMap", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VarValMap == nil {
				m.VarValMap = make(map[uint64]*Value)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorTask = []byte{
	...
	,
}
