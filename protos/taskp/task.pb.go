...
import typesp "github.com/dgraph-io/dgraph/protos/typesp"
...
type Mutations struct {
	...
	Schema  []*typesp.Schema `protobuf:"bytes,3,rep,name=schema" json:"schema,omitempty"`
}
...
func (m *Mutations) GetSchema() []*typesp.Schema {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *Mutations) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Schema = append(m.Schema, &typesp.Schema{})
...
var fileDescriptorTask = []byte{
	...
	,
}
