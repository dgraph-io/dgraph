...
type UIDLease struct {
	...
	LeasedId uint64 `protobuf:"varint,3,opt,name=leased_id,json=leasedId,proto3" json:"leased_id,omitempty"`
}
...
func (m *UIDLease) GetGroupId() uint32 {
	if m != nil {
		return m.GroupId
	}
	return 0
...
func (m *UIDLease) GetNextId() uint64 {
	if m != nil {
		return m.NextId
	}
	return 0
...
func (m *UIDLease) GetLeasedId() uint64 {
	if m != nil {
		return m.LeasedId
	}
	return 0
...
func (m *UIDLease) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NextId != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.NextId))
	}
	if m.LeasedId != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.LeasedId))
	}
	return i, nil
}
...
func (m *UIDLease) Size() (n int) {
	...
	if m.NextId != 0 {
		n += 1 + sovTask(uint64(m.NextId))
	}
	if m.LeasedId != 0 {
		n += 1 + sovTask(uint64(m.LeasedId))
	}
	return n
}
...
func (m *UIDLease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeasedId", wireType)
			}
			m.LeasedId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LeasedId |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTask = []byte{
	...
	,
}
