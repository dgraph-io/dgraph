...
type TypesSchema_Directive int32

const (
	TypesSchema_NONE    TypesSchema_Directive = 0
	TypesSchema_INDEX   TypesSchema_Directive = 1
	TypesSchema_REVERSE TypesSchema_Directive = 2
)

var TypesSchema_Directive_name = map[int32]string{
	0: "NONE",
	1: "INDEX",
	2: "REVERSE",
}
var TypesSchema_Directive_value = map[string]int32{
	"NONE":    0,
	"INDEX":   1,
	"REVERSE": 2,
}

func (x TypesSchema_Directive) String() string {
	return proto.EnumName(TypesSchema_Directive_name, int32(x))
}
func (TypesSchema_Directive) EnumDescriptor() ([]byte, []int) { return fileDescriptorTypes, []int{2, 0} }
...
type TypesSchema struct {
	...
	Directive TypesSchema_Directive `protobuf:"varint,2,opt,name=directive,proto3,enum=protos.TypesSchema_Directive" json:"directive,omitempty"`
	Tokenizer []string              `protobuf:"bytes,3,rep,name=tokenizer" json:"tokenizer,omitempty"`
}

func (m *TypesSchema) Reset()                    { *m = TypesSchema{} }
func (m *TypesSchema) String() string            { return proto.CompactTextString(m) }
func (*TypesSchema) ProtoMessage()               {}
func (*TypesSchema) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{2} }

func (m *TypesSchema) GetValueType() uint32 {
	if m != nil {
		return m.ValueType
	}
	return 0
...
func (m *TypesSchema) GetDirective() TypesSchema_Directive {
	if m != nil {
		return m.Directive
	}
	return TypesSchema_NONE
}

func (m *TypesSchema) GetTokenizer() []string {
	if m != nil {
		return m.Tokenizer
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TypesSchema)(nil), "protos.TypesSchema")
	...
	proto.RegisterEnum("protos.TypesSchema_Directive", TypesSchema_Directive_name, TypesSchema_Directive_value)
}
...
func (m *TypesSchema) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TypesSchema) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TypesSchema) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TypesSchema: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TypesSchema: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Directive |= (TypesSchema_Directive(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
