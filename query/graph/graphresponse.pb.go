...
func (*Schema) Descriptor() ([]byte, []int) { return fileDescriptorGraphresponse, []int{3} }
...
func (m *Schema) GetAttributes() []string {
	if m != nil {
		return m.Attributes
	}
	return nil
...
func (*SchemaDescription) Descriptor() ([]byte, []int) { return fileDescriptorGraphresponse, []int{8} }

func (m *SchemaDescription) GetPredicate() string {
	if m != nil {
		return m.Predicate
	}
	return ""
...
func (m *SchemaDescription) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
type Response struct {
	...
	Schema       []*SchemaDescription `protobuf:"bytes,4,rep,name=schema" json:"schema,omitempty"`
}
...
func (m *Response) GetSchema() []*SchemaDescription {
	if m != nil {
		return m.Schema
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SchemaDescription)(nil), "graph.SchemaDescription")
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Schema = append(m.Schema, &SchemaDescription{})
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
