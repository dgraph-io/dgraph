...
type Property_RawValue struct {
	RawValue *Value `protobuf:"bytes,2,opt,name=raw_value,json=rawValue,oneof"`
}
type Property_NodeValue struct {
	NodeValue *Node `protobuf:"bytes,3,opt,name=node_value,json=nodeValue,oneof"`
}

func (*Property_RawValue) isProperty_Value()  {}
func (*Property_NodeValue) isProperty_Value() {}
...
func (m *Property) GetRawValue() *Value {
	if x, ok := m.GetValue().(*Property_RawValue); ok {
		return x.RawValue
	}
	return nil
}

func (m *Property) GetNodeValue() *Node {
	if x, ok := m.GetValue().(*Property_NodeValue); ok {
		return x.NodeValue
	}
	return nil
}
...
func (*Property) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Property_OneofMarshaler, _Property_OneofUnmarshaler, _Property_OneofSizer, []interface{}{
		(*Property_RawValue)(nil),
		(*Property_NodeValue)(nil),
	}
}
...
func _Property_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Property_RawValue:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawValue); err != nil {
			return err
		}
	case *Property_NodeValue:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.NodeValue); err != nil {
			return err
		}
	case nil:
	default:
...
func _Property_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Property)
	switch tag {
	case 2: // value.raw_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Value)
		err := b.DecodeMessage(msg)
		m.Value = &Property_RawValue{msg}
		return true, err
	case 3: // value.node_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Node)
		err := b.DecodeMessage(msg)
		m.Value = &Property_NodeValue{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Property_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.Value.(type) {
	case *Property_RawValue:
		s := proto.Size(x.RawValue)
		n += proto.SizeVarint(2<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Property_NodeValue:
		s := proto.Size(x.NodeValue)
...
func (m *Property_RawValue) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawValue != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(m.RawValue.Size()))
		n5, err := m.RawValue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *Property_NodeValue) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.NodeValue != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintGraphresponse(dAtA, i, uint64(m.NodeValue.Size()))
		n6, err := m.NodeValue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *Property_RawValue) Size() (n int) {
	var l int
	_ = l
	if m.RawValue != nil {
		l = m.RawValue.Size()
...
func (m *Property_NodeValue) Size() (n int) {
	var l int
	_ = l
	if m.NodeValue != nil {
		l = m.NodeValue.Size()
...
func (m *Property) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Value = &Property_RawValue{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
