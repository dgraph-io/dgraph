...
type Response struct {
	...
	Schema       map[string]string `protobuf:"bytes,4,rep,name=schema" json:"schema,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Response) GetSchema() map[string]string {
	if m != nil {
		return m.Schema
	}
	return nil
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			iNdEx = postStringIndexmapkey
			if m.Schema == nil {
				m.Schema = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
...
var fileDescriptorGraphresponse = []byte{
	...
	,
}
