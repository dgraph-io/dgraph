...
func TestKShortestPathWeighted(t *testing.T) {
	...
	js := processToFastJSON(t, query)
	require.JSONEq(t,
		`{"data": {"_path_":[{"uid":"0x1","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x1f","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e8","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e9"}]}]}]}]}}`,
		js)
}
...
func TestKShortestPathWeighted1(t *testing.T) {
	...
	js := processToFastJSON(t, query)
	require.JSONEq(t,
		`{"data": {"_path_":[{"uid":"0x1","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x1f","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e8","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e9","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3ea","path":[{"@facets":{"_":{"weight":0.600000}},"uid":"0x3eb"}]}]}]}]}]},{"uid":"0x1","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x1f","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e8","path":[{"@facets":{"_":{"weight":0.700000}},"uid":"0x3ea","path":[{"@facets":{"_":{"weight":0.600000}},"uid":"0x3eb"}]}]}]}]},{"uid":"0x1","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x1f","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e8","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e9","path":[{"@facets":{"_":{"weight":1.500000}},"uid":"0x3eb"}]}]}]}]}]}}`,
		js)
}
...
func TestShortestPathWeights(t *testing.T) {
	...
	js := processToFastJSON(t, query)
	require.JSONEq(t,
		`{"data": {"_path_":[{"uid":"0x1","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x1f","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e8","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3e9","path":[{"@facets":{"_":{"weight":0.100000}},"uid":"0x3ea"}]}]}]}]}],"me":[{"name":"Michonne"},{"name":"Andrea"},{"name":"Alice"},{"name":"Bob"},{"name":"Matt"}]}}`,
		js)
}
