...
func (rcv *Query) MutateIsCount(n int32) bool {
...
func QueryAddIsCount(builder *flatbuffers.Builder, isCount int32) { builder.PrependInt32Slot(5, isCount, 0) }
