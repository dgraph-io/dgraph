...
func ResultStart(builder *flatbuffers.Builder) { builder.StartObject(3) }
...
func ResultAddCount(builder *flatbuffers.Builder, count flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(count), 0) }
func ResultStartCountVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT { return builder.StartVector(8, numElems, 8)
}
