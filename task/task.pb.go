...
type Query struct {
	...
	Plugins [][]byte `protobuf:"bytes,9,rep,name=plugins" json:"plugins,omitempty"`
}
...
type Sort struct {
	...
	Plugins   [][]byte `protobuf:"bytes,6,rep,name=plugins" json:"plugins,omitempty"`
}
...
type Mutations struct {
	...
	Plugin  [][]byte        `protobuf:"bytes,3,rep,name=plugin" json:"plugin,omitempty"`
}
...
func (m *Mutations) GetPlugin() [][]byte {
	if m != nil {
		return m.Plugin
	}
	return nil
...
func (m *Query) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Plugins) > 0 {
		for _, b := range m.Plugins {
			dAtA[i] = 0x4a
			i++
			i = encodeVarintTask(dAtA, i, uint64(len(b)))
			i += copy(dAtA[i:], b)
		}
	}
	return i, nil
...
func (m *Query) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.Plugins = append(m.Plugins, make([]byte, postIndex-iNdEx))
			copy(m.Plugins[len(m.Plugins)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTask(dAtA[iNdEx:])
...
func (m *Mutations) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Plugin = append(m.Plugin, make([]byte, postIndex-iNdEx))
			copy(m.Plugin[len(m.Plugin)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTask(dAtA[iNdEx:])
...
var fileDescriptorTask = []byte{
	...
	,
}
