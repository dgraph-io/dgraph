...
type Query struct {
	...
	ChainData []int64  `protobuf:"varint,9,rep,packed,name=chain_data,json=chainData" json:"chain_data,omitempty"`
}
...
func (m *Query) GetChainData() []int64 {
	if m != nil {
		return m.ChainData
	}
	return nil
...
type Result struct {
	...
	ChainData     []int64  `protobuf:"varint,5,rep,packed,name=chain_data,json=chainData" json:"chain_data,omitempty"`
}
...
func (m *Result) GetChainData() []int64 {
	if m != nil {
		return m.ChainData
	}
	return nil
...
func (m *Query) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ChainData) > 0 {
		dAtA2 := make([]byte, len(m.ChainData)*10)
		var j1 int
		for _, num1 := range m.ChainData {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Result) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ChainData) > 0 {
		dAtA6 := make([]byte, len(m.ChainData)*10)
		var j5 int
		for _, num1 := range m.ChainData {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType == 0 {
				...
				m.ChainData = append(m.ChainData, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ChainData", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipTask(dAtA[iNdEx:])
...
var fileDescriptorTask = []byte{
	...
	,
}
