...
type Query struct {
	...
	// search all possible result based on attribute
	// used at root level
	IsSearchAll bool `protobuf:"varint,10,opt,name=is_search_all,json=isSearchAll,proto3" json:"is_search_all,omitempty"`
}
...
func (m *Query) GetIsSearchAll() bool {
	if m != nil {
		return m.IsSearchAll
	}
	return false
}
...
func (m *Query) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsSearchAll", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorTask = []byte{
	...
	,
}
