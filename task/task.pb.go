...
func (*Attr) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{10} }
...
type DirectedEdge struct {
	...
	Attrs     []*Attr         `protobuf:"bytes,9,rep,name=attrs" json:"attrs,omitempty"`
}
...
func (m *DirectedEdge) GetAttrs() []*Attr {
	if m != nil {
		return m.Attrs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Attr)(nil), "task.Attr")
...
func (m *Attr) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Val != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.Val.Size()))
		n5, err := m.Val.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
var fileDescriptorTask = []byte{
	...
	,
}
