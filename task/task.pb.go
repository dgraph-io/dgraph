...
type Sort struct {
	...
	DestUids  *List   `protobuf:"bytes,6,opt,name=dest_uids,json=destUids" json:"dest_uids,omitempty"`
	IsParent  bool    `protobuf:"varint,7,opt,name=is_parent,json=isParent,proto3" json:"is_parent,omitempty"`
}
...
type SortResult struct {
	UidMatrix []*List `protobuf:"bytes,1,rep,name=uid_matrix,json=uidMatrix" json:"uid_matrix,omitempty"`
	UidList   *List   `protobuf:"bytes,2,opt,name=uid_list,json=uidList" json:"uid_list,omitempty"`
}
...
func (m *SortResult) GetUidList() *List {
	if m != nil {
		return m.UidList
	}
	return nil
...
func (m *Sort) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DestUids != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintTask(dAtA, i, uint64(m.DestUids.Size()))
		n3, err := m.DestUids.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *SortResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UidList != nil {
		...
		n4, err := m.UidList.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *Sort) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DestUids", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DestUids.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsParent", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorTask = []byte{
	...
	,
}
