...
type Mutations struct {
	...
	SchemaUpdate []*SchemaUpdate `protobuf:"bytes,3,rep,name=schema_update,json=schemaUpdate" json:"schema_update,omitempty"`
}
...
func (m *Mutations) GetSchemaUpdate() []*SchemaUpdate {
	if m != nil {
...
func (*SchemaUpdate) Descriptor() ([]byte, []int) { return fileDescriptorTask, []int{12} }

func (m *SchemaUpdate) GetAttr() string {
	if m != nil {
		return m.Attr
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SchemaUpdate)(nil), "task.SchemaUpdate")
...
func (m *Mutations) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SchemaUpdate) > 0 {
		for _, msg := range m.SchemaUpdate {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintTask(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Mutations) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SchemaUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SchemaUpdate = append(m.SchemaUpdate, &SchemaUpdate{})
			if err := m.SchemaUpdate[len(m.SchemaUpdate)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTask = []byte{
	...
	,
}
