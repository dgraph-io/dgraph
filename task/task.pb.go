...
type Query struct {
	...
	SrcFunc []string `protobuf:"bytes,7,rep,name=srcFunc" json:"srcFunc,omitempty"`
}
...
type Result struct {
	...
	DestUids  *List    `protobuf:"bytes,4,opt,name=destUids" json:"destUids,omitempty"`
}
...
func (m *Result) GetDestUids() *List {
	if m != nil {
		return m.DestUids
	}
	return nil
...
var fileDescriptorTask = []byte{
	...
	,
}
