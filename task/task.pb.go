...
type Query struct {
	...
	PluginContexts []string `protobuf:"bytes,9,rep,name=plugin_contexts,json=pluginContexts" json:"plugin_contexts,omitempty"`
}
...
func (m *Query) GetPluginContexts() []string {
	if m != nil {
...
type Sort struct {
	...
	PluginContexts []string `protobuf:"bytes,6,rep,name=plugin_contexts,json=pluginContexts" json:"plugin_contexts,omitempty"`
}
...
func (m *Sort) GetPluginContexts() []string {
	if m != nil {
		return m.PluginContexts
	}
	return nil
...
func (m *Num) GetPluginContexts() []string {
	if m != nil {
		return m.PluginContexts
	}
	return nil
...
type DirectedEdge struct {
	...
	PluginContexts []string        `protobuf:"bytes,8,rep,name=plugin_contexts,json=pluginContexts" json:"plugin_contexts,omitempty"`
}
...
func (m *DirectedEdge) GetPluginContexts() []string {
	if m != nil {
		return m.PluginContexts
	}
	return nil
...
type RebuildIndex struct {
	GroupId        uint32   `protobuf:"varint,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	Attr           string   `protobuf:"bytes,2,opt,name=attr,proto3" json:"attr,omitempty"`
	PluginContexts []string `protobuf:"bytes,3,rep,name=plugin_contexts,json=pluginContexts" json:"plugin_contexts,omitempty"`
}
...
func (m *RebuildIndex) GetPluginContexts() []string {
	if m != nil {
		return m.PluginContexts
	}
	return nil
...
var fileDescriptorTask = []byte{
	...
	,
}
