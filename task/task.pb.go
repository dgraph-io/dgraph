...
import fmt "fmt"
import math "math"
import dproto "github.com/dgraph-io/dgraph/dproto"
...
type DirectedEdge struct {
	...
	Facets    []*dproto.Facet `protobuf:"bytes,9,rep,name=facets" json:"facets,omitempty"`
}
...
func (m *DirectedEdge) GetFacets() []*dproto.Facet {
	if m != nil {
		return m.Facets
	}
	return nil
...
func (m *DirectedEdge) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.Facets = append(m.Facets, &dproto.Facet{})
...
var fileDescriptorTask = []byte{
	...
	,
}
