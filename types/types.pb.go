...
type Posting struct {
	...
	ValType dproto.ValType  `protobuf:"varint,3,opt,name=val_type,json=valType,proto3,enum=dproto.ValType" json:"val_type,omitempty"`
	Lang    string          `protobuf:"bytes,4,opt,name=lang,proto3" json:"lang,omitempty"`
	Label   string          `protobuf:"bytes,5,opt,name=label,proto3" json:"label,omitempty"`
	Commit  uint64          `protobuf:"varint,6,opt,name=commit,proto3" json:"commit,omitempty"`
	Facets  []*dproto.Facet `protobuf:"bytes,7,rep,name=facets" json:"facets,omitempty"`
...
func (m *Posting) GetValType() dproto.ValType {
	if m != nil {
		return m.ValType
	}
	return dproto.ValType_STRING
}
...
func (m *Posting) GetFacets() []*dproto.Facet {
	if m != nil {
		return m.Facets
	}
	return nil
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ValType |= (dproto.ValType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorTypes = []byte{
	...
	,
}
