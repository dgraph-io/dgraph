...
Our Dgraph is an open source, scalable, transactional, distributed, highly available, fast,
and native graph database, designed from ground up to be run in production.
