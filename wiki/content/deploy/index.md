...
```sh
dgraph alpha --whitelist 172.17.0.0/16,172.18.0.0/15,172.20.0.0/32,192.168.1.1/32 --lru_mb <one-third RAM> ...
```
...
```sh
dgraph alpha --whitelist admin-bastion,host.docker.internal --lru_mb <one-third RAM> ...
```
