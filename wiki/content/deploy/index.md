...
* `/health` returns information about the health of all the servers in the cluster.
...
You could query the same information by hitting the `/health` endpoint as well.
