...
{{% notice "note" %}}
Encrypted backups are secured using symmetric encryption. When restoring an encrypted backup,
the online restore process key is the same key used when deploying Dgraph.
{{% /notice %}}
