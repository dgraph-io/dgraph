...
query block and then, can be used in the mutation block using the `uid` function.
...
The mutation first checks whether a user with the email `user@dgraph.io` exists. Because
