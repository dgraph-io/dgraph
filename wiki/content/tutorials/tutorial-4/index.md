...
In the [previous tutorial]({{< relref "tutorials/tutorial-3/index.md" >}}), we learned about Datatypes, Indexing, Filtering, and Reverse traversals in Dgraph.
...
```
_Note: If this mutation syntax is new to you, refer to the [first tutorial]({{< relref "tutorials/tutorial-1/index.md">}}) to learn basics of mutation in Dgraph._
...
_Note: Check out the [previous tutorial]({{< relref "tutorials/tutorial-3/index.md">}}) to know more about data types in Dgraph._
...
_Note: Check the [second tutorial]({{< relref "tutorials/tutorial-2/index.md">}}) if you want to learn more about traversal queries like the above one_
...
_Note: If you're not clear about basic terminology like `predicates`, do read the [first tutorial]({{< relref "tutorials/tutorial-1/index.md">}})._
...
In the [previous article]({{< relref "tutorials/tutorial-3/index.md">}}), we learned about using the `eq` operator and the `hash` index to query for string predicate values.
...
Check out our next tutorial of the getting started series [here]({{< relref "tutorials/tutorial-5/index.md" >}}).
